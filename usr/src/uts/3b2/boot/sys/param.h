...
#ident	"@(#)boot:boot/sys/param.h	11.4"
/*
...
#ifndef NODEV
#define	NODEV	(o_dev_t)(-1)
#endif
#define	ROOTINO	((o_ino_t)2)	/* i number of all roots */
...
#define	NSHIFT		7		/* log2(NINDIR) */
#define NDPC		4
#define FsBSIZE(dev)	(2048 >> (3 - dev))
#define FsBSHIFT(dev)	(11 - (3 - dev))
#define FsNINDIR(dev)	(512 >> (3 - dev))
#define FsBMASK(dev)	(03777 >> (3 - dev))
#define FsINOPB(dev)	(32 >> (3 - dev))
#define FsLTOP(dev, b)	(b << (dev - 1))
#define FsPTOL(dev, b)	(b >> (dev - 1))
#define FsNMASK(dev)	(0777 >> (3 - dev))
#define FsNSHIFT(dev)	(9 - (3 - dev))
#define FsITOD(dev, x)	(daddr_t)(((unsigned)x + (63 >> (3 - dev))) >> (5 - (3 - dev)))
#define FsITOO(dev, x)	(daddr_t)(((unsigned)x + (63 >> (3-dev)))&(037 >> (3-dev)))
#define FsINOS(dev, x)	((x & ~(037 >> (3 - dev))) + 1)
#endif

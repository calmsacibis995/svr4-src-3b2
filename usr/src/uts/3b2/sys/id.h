...
#define IDPDBLKNO	(daddr_t)0x00
#define IDVTOCBLK	(daddr_t)0x01
...
struct idspecparam {
	...
	unsigned char	rwch;	/* reduced write current start cyl: hi byte */
	unsigned char	rwcl;	/* reduced write current start cyl: lo byte */
};

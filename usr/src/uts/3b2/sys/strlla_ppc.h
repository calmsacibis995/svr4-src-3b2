...
#ifndef _SYS_STRLLA_PPC_H
#define _SYS_STRLLA_PPC_H

#ident	"@(#)head.sys:sys/strlla_ppc.h	1.3"
/*
 * The following are general-purpose macros for accessing the
 * various queues, elements, and fields of the PPC CIO interface
 */

#define R_QUEUE(b)	(npp_board[b].rqueue)
#define C_QUEUE(b)	(npp_board[b].cqueue)

...
#ifndef _SYS_DISASM_H
#define _SYS_DISASM_H

#ident	"@(#)head.sys:sys/disasm.h	11.2"
/*
 *	taken from m32-SGS -- m32/dis.h: 1.2 6/9/82
 */
...
#define		NCHPS	10	/* number of chars per symbol	*/

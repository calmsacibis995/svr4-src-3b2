...
#ident	"@(#)head.sys:sys/vnode.h	1.29"
...
#define	VOP_LINK(tdvp,fvp,p,cr) (*(fvp)->v_op->vop_link)(tdvp,fvp,p,cr)
...
#define	VOP_DUMP(vp,addr,bn,count) (*(vp)->v_op->vop_dump)(vp,addr,vn,count)

...
#ident	"@(#)head.sys:sys/hrtcntl.h	1.7"
...
int	hrtcntl(const int, const int, interval_t *const, hrtime_t *const);
int	hrtalarm(hrtcmd_t *const, const int);
int	hrtsleep(hrtcmd_t *const);
int	hrtcancel(const long *, const int);
#endif

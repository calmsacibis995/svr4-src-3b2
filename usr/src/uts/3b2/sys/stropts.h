...
#ident	"@(#)head.sys:sys/stropts.h	11.17"
...
/*
 * This is not settable by the user.  It is set on return to
 * indicate that the message received is in the priority band
 * identified by the "prip" parameter to the getpmsg system call.
 */

...
#ident	"@(#)head.sys:sys/firmware.h	11.6"
...
#define	VSIZOFMEM	(*(((struct vectors *)VBASE)->p_memsize))
...
#if defined(__STDC__)
extern void rtnfirm(void);
extern int cache_on(void);
extern int cache_off(void);
extern int call_demon(void);
#else
extern void rtnfirm();
extern int cache_on();
extern int cache_off();
extern int call_demon();
#endif	/* __STDC__ */

#endif	/* _KERNEL */
#endif	/* _SYS_FIRMWARE_H */

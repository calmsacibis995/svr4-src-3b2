...
#ident	"@(#)head.sys:sys/vmparam.h	1.3"

/* this file has not been converted for the 3b2 yet */
...
#define	USRSTACK	(0 - (128 * 1024*1024))
 ...
 */
#ifndef DFLDSIZ
#define	DFLDSIZ		(512 * 1024*1024)	/* initial data size limit */
#endif
#ifndef MAXDSIZ
...
#endif
#ifndef MAXSSIZ
#define	MAXSSIZ		MAXDSIZ			/* max stack size limit */
#endif

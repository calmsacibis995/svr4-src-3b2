...
#ident	"@(#)head.sys:sys/nvram.h	11.11"
/*
 *	Non-Volatile RAM
 */
...
#if defined(__STDC__)
extern void dumpnvram(struct xtra_nvr *);
extern int rnvram(caddr_t, caddr_t, int);
extern int wnvram(caddr_t, caddr_t, int);
#else
extern void dumpnvram();
extern int rnvram();
extern int wnvram();
#endif

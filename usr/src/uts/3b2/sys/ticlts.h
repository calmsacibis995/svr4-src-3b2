...
#ident	"@(#)head.sys:sys/ticlts.h	1.4"
/*
 ...
 *	basic constants
 */
#define TCL_NENDPT		(MAXMIN+1)
#define TCL_SERVTYPE		T_CLTS
#define TCL_TIDUSZ		(8*1024)		/* max packet size */
...
#define TCL_ADDRSZ		(TCL_TIDUSZ-24)		/* 24 = sizeof(struct T_bind_req) + 8

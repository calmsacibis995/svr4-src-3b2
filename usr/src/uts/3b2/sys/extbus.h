...
#ifndef _SYS_EXTBUS_H
#define _SYS_EXTBUS_H

#ident	"@(#)head.sys:sys/extbus.h	11.5"
/*
...
/* 
 * The following information is used by filledt and cunix to handle
 * extended bus devices. The extended EDT table is written to the
 * last 25 blocks of the boot block.
 */
#define XEDTSTART 0x202c000  /* where edtgen loads extended edt */
#define XEDTSIZE 25	     /* Number of blocks to use for extended EDT */
#define XEDTMAGIC 0x676f7268 /* Magic number for extended EDT */

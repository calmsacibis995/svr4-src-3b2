...
#ident	"@(#)head.sys:sys/ticotsord.h	1.3"
/*
...
#endif
#define TCOO_TIDUSZ		(8*1024)		/* max packet size */
...
#define TCOO_ADDRSZ		(TCOO_TIDUSZ-16)		/* 16 = sizeof(struct T_bind_req)

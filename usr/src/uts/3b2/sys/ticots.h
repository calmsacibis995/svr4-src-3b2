...
#ident	"@(#)head.sys:sys/ticots.h	1.4"
/*
...
#endif
#define TCO_TIDUSZ		(8*1024)		/* max packet size */
...
#define TCO_ADDRSZ		(TCO_TIDUSZ-16)		/* 16 = sizeof(struct T_bind_req)

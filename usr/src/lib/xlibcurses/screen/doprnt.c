...
#ident	"@(#)curses:screen/doprnt.c	1.10"
/*
 ...
 * If you have a machine not in the list below that should be, please
 * let me know so I can keep the master copy current -- MRH
 */

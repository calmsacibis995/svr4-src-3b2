 ...
 *	<sys/types.h>	    Data types known to the kernel (needed by sys3b.h)
 *	<sys/sys3b.h>	    Definitions for the sys3b() kernel call
 ...
 *	On the 3B2, this is whatever is returned by the S3BMEM
 *	option to the sys3b() function.
 *
 *  Arguments: None
 * 	
 *  Returns:  long
 *	Whatever sys3b(S3BMEM) returns.
 */

long 
sysmem()
{
	return ((long) sys3b(S3BMEM));
}

/*
 * int asysmem()

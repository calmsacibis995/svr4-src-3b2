	.file	"sspecial.s"
.ident	"@(#)libc-m32:fp/sspecial.s	1.3.1.3"
...
_fgdef_(_trap.single):
	...
	pushaw	_sref_(.format)		# push address of
...
#----------------------------------------
	.globl	_qnan1.single
_fgdef_(_qnan1.single):			# return argument 1
.ret_arg1:
	movw	0(%ap),%r0
	ret	&6
#---------------------------------------
	.globl	_qnan2.single
_fgdef_(_qnan2.single):			# return argument 2
.ret_arg2:
	movw	4(%ap),%r0
	ret	&6
#--------------------------------------------------------------------------
	.globl	_inf1.single
_fgdef_(_inf1.single):			# return arg1
	jmp	.ret_arg1
#-------------------------------------------------------------------------
	.globl	_inf2.single
_fgdef_(_inf2.single):
	jmp	.ret_arg2

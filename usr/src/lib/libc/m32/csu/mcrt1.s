...
# global entities defined in this file
	.globl	_start		# executable's prologue entry point
	.globl	_eprol		# end of prologue, beginning of user text
	.globl	_init		# user code start - why global????
	.globl	exit
	.globl	_fini
	_wdecl_(_cleanup)
...
#
	SUBW3	&_eprol,&(etext+7),%r8		# get text size in double words

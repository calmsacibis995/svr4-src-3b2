 ...
 */
const static char shifts[] = { 1,1,2,2,2,2,2,2,1,2,2,2,2,2,2,1, };
...
int	edflag;
{
	...
	if(edflag)
		des_decrypt1(block, L, IP, &L[32], preS, E, KS, S, f, tempL, P, FP);
#endif 
	else
		des_encrypt1(block, L, IP, &L[32], preS, E, KS, S, f, tempL, P, FP);
}

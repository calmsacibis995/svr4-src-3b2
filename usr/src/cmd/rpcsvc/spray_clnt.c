...
*/ 
#ifndef lint
static	char sccsid[] = "@(#)spray_clnt.c 1.1 89/03/23 Copyr 1984 Sun Micro";
#endif
	...
	CLIENT *clnt;
{
	...
	(void) memset((char *)&res, 0, sizeof(res));
	if (clnt_call(clnt, SPRAYPROC_GET, xdr_void, argp, xdr_spraycumul, &res, TIMEOUT) != RPC_SUCCESS) {
		return (NULL);
	}
	return (&res);
}

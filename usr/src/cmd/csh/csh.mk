...
DEFS= -DBSD_COMP -DTELL -DVFORK -DFILEC -Dm32
CFLAGS=	$(DEFS) $(MBCHAR) -O -I. -I$(INC)
LINK_LIBS= -ltermlib
...
SRCS=	printf.c sh.c sh.char.c sh.debug.c sh.dir.c sh.dol.c sh.err.c \
	...
	sh.tchar.c sh.tconst.c sh.time.c stubs.c \
...
OBJS=	printf.o sh.char.o sh.debug.o sh.dir.o sh.dol.o sh.err.o \
	...
	sh.tchar.o sh.tconst.o sh.time.o sh.o stubs.o \
...
csh: $(OBJS)
	rm -f csh
	$(CC) $(OBJS) -o csh $(LINK_LIBS) $(SHLIBS)

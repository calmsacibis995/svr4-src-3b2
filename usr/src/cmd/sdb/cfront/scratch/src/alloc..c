...
#ident	"@(#)sdb:cfront/scratch/src/alloc..c	1.2"
...
{ 
#line 13 "../../src/alloc.c"
fprintf ( stderr, (char *)"free store: %d bytes alloc()=%d free()=%d\n", Nfree_store , Nalloc , Nfree ) ;
fprintf ( stderr, (char *)"%d chunks: %d (%d)\n", Nchunk , 8192, Nchunk * 8192) ;
}
;

#line 18 "../../src/alloc.c"
extern char *chunk (_au0_i )int _au0_i ;
{ 
#line 20 "../../src/alloc.c"
register char *_au1_cp ;

#line 20 "../../src/alloc.c"
_au1_cp = malloc ( (unsigned int )((_au0_i * 8192)- 8 )) ;
if (_au1_cp == 0 ){ 
#line 22 "../../src/alloc.c"
free ( ((char *)gtbl )) ;
if (Nspy )print_free ( ) ;
errorFI_PC_RCea__RCea__RCea__RCea___ ( (int )'i' , (char *)"free store exhausted", (struct ea *)ea0 , (struct ea *)ea0 , (struct ea *)ea0 , (struct ea *)ea0 ) ;
#line 24 "../../src/alloc.c"
}

#line 26 "../../src/alloc.c"
Nchunk += _au0_i ;
Nfree_store += (_au0_i * 8192);
return (char *)_au1_cp ;
}
;
char *_new (_au0_sz )long _au0_sz ;
{ 
#line 33 "../../src/alloc.c"
char *_au1_p ;

#line 33 "../../src/alloc.c"
_au1_p = calloc ( (unsigned int )_au0_sz , (unsigned int )1 ) ;
...
#line 41 "../../src/alloc.c"
Nalloc ++ ;
Nfree_store += (_au0_sz + (sizeof (int *)));
return (char *)_au1_p ;
}
;
int NFn = 0 ;
...
#line 55 "../../src/alloc.c"
_au2_pp = (((struct name *)_au0_p ));
_au2_t = _au2_pp -> _node_base ;
Nfree ++ ;
Nfree_store -= (((((((int *)_au0_p ))[-1])- (((int )_au0_p )))- 1 )+ (sizeof (int *)));
switch (_au2_t ){ 
#line 60 "../../src/alloc.c"
case 21 : case 5 : case 97 : case 38 : case 29 : case 22 :
#line 60 "../../src/alloc.c"

#line 61 "../../src/alloc.c"
case 15 : case 11 : case 119 : case 121 : case 114 : 
#line 62 "../../src/alloc.c"
NFbt ++ ;
...
#line 69 "../../src/alloc.c"
case 82 : case 84 : case 81 : case 83 : case 34 : 
#line 70 "../../src/alloc.c"
NFc ++ ;

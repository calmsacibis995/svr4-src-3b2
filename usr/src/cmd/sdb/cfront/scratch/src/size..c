...
#ident	"@(#)sdb:cfront/scratch/src/size..c	1.2"
...
#line 53 "../../src/size.c"
int get_line (_au0_fp )FILE *_au0_fp ;
{ 
#line 55 "../../src/size.c"
char _au1_s [32];

#line 58 "../../src/size.c"
if (fscanf ( _au0_fp , (char *)" %s %d %d", _au1_s , & arg1 , & arg2 ) <= 0 )return (int )0 ;
#line 58 "../../src/size.c"

#line 60 "../../src/size.c"
if (strcmp ( (char *)"char", (char *)_au1_s ) == 0 ){ 
#line 61 "../../src/size.c"
SZ_CHAR = arg1 ;
AL_CHAR = arg2 ;
return 1 ;
}
if (strcmp ( (char *)"short", (char *)_au1_s ) == 0 ){ 
#line 66 "../../src/size.c"
SZ_SHORT = arg1 ;
AL_SHORT = arg2 ;
return 1 ;
}
if (strcmp ( (char *)"int", (char *)_au1_s ) == 0 ){ 
#line 71 "../../src/size.c"
SZ_INT = arg1 ;
AL_INT = arg2 ;
if (fscanf ( _au0_fp , (char *)" %s", _au1_s ) <= 0 )return (int )0 ;
LARGEST_INT = (((char *)_new ( (long )((sizeof (char ))* (strlen ( (char *)_au1_s ) + 1 ))) ));
strcpy ( LARGEST_INT , (char *)_au1_s ) ;
return 1 ;
}
if (strcmp ( (char *)"long", (char *)_au1_s ) == 0 ){ 
#line 79 "../../src/size.c"
SZ_LONG = arg1 ;
AL_LONG = arg2 ;
return 1 ;
}
if (strcmp ( (char *)"float", (char *)_au1_s ) == 0 ){ 
#line 84 "../../src/size.c"
SZ_FLOAT = arg1 ;
AL_FLOAT = arg2 ;
return 1 ;
}
if (strcmp ( (char *)"double", (char *)_au1_s ) == 0 ){ 
#line 89 "../../src/size.c"
SZ_DOUBLE = arg1 ;
AL_DOUBLE = arg2 ;
return 1 ;
}
if (strcmp ( (char *)"bit", (char *)_au1_s ) == 0 ){ 
#line 94 "../../src/size.c"
BI_IN_BYTE = arg1 ;
BI_IN_WORD = arg2 ;
return 1 ;
}
if (strcmp ( (char *)"struct", (char *)_au1_s ) == 0 ){ 
#line 99 "../../src/size.c"
SZ_STRUCT = arg1 ;
AL_STRUCT = arg2 ;
return 1 ;
}
if (strcmp ( (char *)"struct2", (char *)_au1_s ) == 0 ){ 
#line 104 "../../src/size.c"
F_SENSITIVE = arg1 ;
F_OPTIMIZED = arg2 ;
return 1 ;
}
if (strcmp ( (char *)"frame", (char *)_au1_s ) == 0 ){ 
#line 111 "../../src/size.c"
return 1 ;
}
if (strcmp ( (char *)"word", (char *)_au1_s ) == 0 ){ 
#line 114 "../../src/size.c"
SZ_WORD = arg1 ;
return 1 ;
}
if (strcmp ( (char *)"wptr", (char *)_au1_s ) == 0 ){ 
#line 118 "../../src/size.c"
SZ_WPTR = arg1 ;
AL_WPTR = arg2 ;
return 1 ;
}
if (strcmp ( (char *)"bptr", (char *)_au1_s ) == 0 ){ 
#line 123 "../../src/size.c"
SZ_BPTR = arg1 ;
AL_BPTR = arg2 ;
return 1 ;
}
if (strcmp ( (char *)"top", (char *)_au1_s ) == 0 ){ 
#line 130 "../../src/size.c"
return 1 ;
}
return (int )0 ;
...
;
extern int read_align (_au0_f )char *_au0_f ;
{ 
#line 137 "../../src/size.c"
FILE *_au1_fp ;

#line 137 "../../src/size.c"
_au1_fp = fopen ( (char *)_au0_f , (char *)"r") ;
if (_au1_fp == 0 )return 1 ;
while (get_line ( _au1_fp ) );
return (int )0 ;
}
;
extern int print_align (_au0_s )char *_au0_s ;
{ 
#line 145 "../../src/size.c"
fprintf ( stderr, (char *)"%s sizes and alignments\n\n", _au0_s ) ;

#line 147 "../../src/size.c"
fprintf ( stderr, (char *)"	size	align	largest\n") ;
fprintf ( stderr, (char *)"char	%d	%d\n", SZ_CHAR , AL_CHAR ) ;
fprintf ( stderr, (char *)"short	%d	%d\n", SZ_SHORT , AL_SHORT ) ;
fprintf ( stderr, (char *)"int	%d	%d	%s\n", SZ_INT , AL_INT , LARGEST_INT ) ;
fprintf ( stderr, (char *)"long	%d	%d\n", SZ_LONG , AL_LONG ) ;
fprintf ( stderr, (char *)"float	%d	%d\n", SZ_FLOAT , AL_FLOAT ) ;
fprintf ( stderr, (char *)"double	%d	%d\n", SZ_DOUBLE , AL_DOUBLE ) ;
fprintf ( stderr, (char *)"bptr	%d	%d\n", SZ_BPTR , AL_BPTR ) ;
fprintf ( stderr, (char *)"wptr	%d	%d\n", SZ_WPTR , AL_WPTR ) ;
fprintf ( stderr, (char *)"struct	%d	%d\n", SZ_STRUCT , AL_STRUCT ) ;
fprintf ( stderr, (char *)"struct2	%d	%d\n", F_SENSITIVE , F_OPTIMIZED ) ;

#line 161 "../../src/size.c"
fprintf ( stderr, (char *)"%d bits in a byte, %d bits in a word, %d bytes in a word\n", BI_IN_BYTE , BI_IN_WORD , SZ_WORD ) ;
return 1 ;
}
;

#line 166 "../../src/size.c"
extern int c_strlen (_au0_s )char *_au0_s ;
...
#line 178 "../../src/size.c"
_au1_i = 1 ;
for(_au1_p = _au0_s ;*_au1_p ;( (_au1_i ++ ), (_au1_p ++ )) ) { 
#line 180 "../../src/size.c"
if ((*_au1_p )== '\\' ){ 
#line 181 "../../src/size.c"
switch (*(++ _au1_p )){

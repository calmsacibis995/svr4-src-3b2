...
#ident	"@(#)sdb:cfront/src/size.c	1.1"
/*ident	"@(#)cfront:src/size.c	1.8" */
/*********************************************************************
...
int get_line(FILE* fp)
{
	char s[32];
        ...
        // fscanf returning 0 rather than EOF reading align file in some instances! 
	if (fscanf(fp," %s %d %d",s,&arg1,&arg2) <= 0) return 0;

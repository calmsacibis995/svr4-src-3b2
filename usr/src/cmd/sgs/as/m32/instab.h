...
#define CBPCREL		0xcf	/* byte, pc-relative */
#define CHPCREL		0xaf	/* half, pc-relative */
...
#define BRBOPCD		0x7bL
#define BRHOPCD		0x7aL
#define JSBOPCD		0x34L
#define BSBBOPCD	0x37L
#define BSBHOPCD	0x36L

...
#ident	"@(#)acomp:m32mau/mddefs.h	51.6"
/* mddefs.h */
...
/* This macro fetches the correct debugging register number from
** CG's table for m32mau version of compiler.
*/
#define	DB_OUTREGNO(sid)	regout[SY_REGNO(sid)]

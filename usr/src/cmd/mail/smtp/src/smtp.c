...
#ident	"@(#)mail:smtp/src/smtp.c	1.3"
#ident "@(#)smtp.c	1.3 'attmail mail(1) command'"
/*
...
#define	USAGE "usage: %s [-u] [-H helohost] [-d domain] sender targethost recip1 recip2 ...\n"
...
char *argv[];
{
	...
	while ((c = getopt(argc, argv, "a:uDd:H:")) != EOF)
		switch (c) {
		case 'a':
			addr = optarg;
			break;

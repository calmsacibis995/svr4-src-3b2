...
#ident	"@(#)mail:mail/ckdlivopts.c	1.5"
#ident "@(#)ckdlivopts.c	2.9 'attmail mail(1) command'"
/*
    NAME
	...
	processed. Returns specified options as combined from H_DEFOPT,
	H_TROPT, & H_TCOPY lines.

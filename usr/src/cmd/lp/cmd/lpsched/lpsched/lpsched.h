...
#ident	"@(#)nlp:cmd/lpsched/lpsched.h	1.9.1.2"
...
int		cancel_alert ( int , ... );
int		disable ( PSTATUS * , char * , int );
int		docancel ( RSTATUS * , int );
int		enable ( PSTATUS * );
int		exec ( int , ... );
...
void		queue_attract ( PSTATUS * , int (*)( RSTATUS * ) );
...
extern int		CT_Size,	/* Size of class table		*/
			...
			ST_Size,	/* Size of system table		*/
			PWT_Size,	/* Size of print wheel table	*/
			ST_Count;	/* Occupancy of system table	*/

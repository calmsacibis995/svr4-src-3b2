...
#ident	"@(#)nlp:cmd/lpsched/nodes.h	1.8.1.2"
...
#define	EX_NETWORK	7	/* start or talk to a remote service	*/
...
#define	NODE		MESG
#define send		mputm
#define mallocfail()	fail("Memeory allocation failed!\n")

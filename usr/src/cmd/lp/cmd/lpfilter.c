...
P "usage:"						X
P ""							X
P "  (add or change filter)"				X
P "    lpfilter -f filter-name {-F path-name | -}"	X
P ""							X
P "  (restore delivered filter)"			X
P "    lpfilter -f filter-name -i"			X
P ""							X
P "  (list a filter)"					X
P "    lpfilter -f filter-name -l"			X
P ""							X
P "  (list all filters)"				X /* MR bl88-06850 */
P "    lpfilter -f \"all\" -l"				X
P ""							X
P "  (delete filter)"					X
P "    lpfilter -f filter-name -x"			X
P ""							X
	return;
}

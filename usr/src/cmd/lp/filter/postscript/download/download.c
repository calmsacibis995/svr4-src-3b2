...
#ident	"@(#)lp:filter/postscript/download/download.c	1.2"
/*
 *
...
char	*mapname = NULL;		/* map table - usually in *hostfontdir */
char	*suffix = ".map";		/* appended to the map table pathname */
...

{
    ...
    int		interrupt();		/* handles signals if we catching them */

...
#ident	"@(#)cmd-inet:usr.sbin/in.named/tools/nstest.c	1.1"
	...
	char **argv;
{
	...
	_res.nsaddr.sin_addr.s_addr = /* INADDR_ANY; */ htonl(0x7F000001);
...
usage()
{
	fprintf(stderr, "Usage: %s [-v] [-i] [-r] [-d] [-p port] hostaddr [logfile]\n",
		progname);
	exit(1);
}

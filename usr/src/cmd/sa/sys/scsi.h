...
struct sense{
	...
	unsigned sd_res1    : 8;	/* Reserved field               */
	...
	unsigned sd_ba;			/* Block address                */
	unsigned sd_len     : 8;	/* Additional sense data length */
	unsigned sd_res3    : 24;	/* Reserved field               */
	unsigned sd_res4    : 8;	/* Reserved field               */
	unsigned sd_sencode : 8;	/* Additional sense code        */
	unsigned sd_res5    : 8;	/* Reserved field               */
	unsigned sd_fru     : 8;	/* Failing unit                 */
	...
	unsigned sd_field   : 16;	/* Field pointer to error       */
};

/* The Inquiry data sturcture  */
struct ident{
	unsigned id_type    : 8;	/* Peripheral device type       */
	unsigned id_rmb     : 1;	/* Removable media              */
	unsigned id_qualif  : 7;	/* Device type qualifier        */
	unsigned id_ver     : 8;	/* Version                      */
	unsigned id_res1    : 4;	/* Reserved field               */
	unsigned id_form    : 4;	/* Response data format         */
	unsigned id_len     : 8;	/* Length of additional data    */
	unsigned id_vu      : 24;	/* Vendor unique                */

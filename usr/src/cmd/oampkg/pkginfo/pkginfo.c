...
#ident	"@(#)oampkg:pkginfo/pkginfo.c	1.16.1.1"
...
usage()
{
	...
	(void) fprintf(stderr, "  -x #extended listing\n"); 
	(void) fprintf(stderr, "  -l #short listing\n"); 
	(void) fprintf(stderr, "and options may include:\n");
	(void) fprintf(stderr, "  -c category,[category...]\n");
	(void) fprintf(stderr, "  -a architecure\n");

	...
	char	**argv;
{
	...
	/*
	 * Try to umount the special.
	 * If that fails, try the corresponding mount point
	 * (if one was found and the special is not already a directory)
	 */

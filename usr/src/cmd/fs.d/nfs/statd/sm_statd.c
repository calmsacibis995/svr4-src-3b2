...
#ident	"@(#)nfs.cmds:nfs/statd/sm_statd.c	1.2"
/*
	...
	char *name;
{
	...
	if ((err = call_rpc(name, SM_PROG, SM_VERS, SM_NOTIFY, xdr_notify, &ntf,
		xdr_void, NULL, 0)) == (int) RPC_TIMEDOUT || err == (int) RPC_SUCCESS) {
		return (0);
	}
	else {

...
#ident	"@(#)nfs.cmds:nfs/statd/statd.mk	1.7"

BINS= statd
OBJS= sm_svc.o sm_proc.o sm_statd.o sm_svcreate.o xdr_sm.o \
      ti_opts.o hash.o svc_dg.o rpc.o
SRCS= $(OBJS:.o=.c)
...
LDFLAGS = -s
COFFLIBS= -lrpc -ldes -lnsl_s -lnet -lsocket
ELFLIBS = -lrpcsvc -lnsl

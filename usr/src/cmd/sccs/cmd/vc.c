...
char	*fmalloc();
void	ffree(), setsig(), exit();
unsigned int	strlen();
static int	putin(), lookup(), door(), doand(), exp(), numcomp(); 
int	imatch(), fatal();
int	strcmp(), any();

static void	asgfunc(), dclfunc(), errfunc(), msgfunc(), repfunc();
static void	endfunc(), iffunc(), numck();
static void	chksize();

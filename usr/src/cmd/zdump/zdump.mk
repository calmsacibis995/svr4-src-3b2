...
zdump:		zdump.o  ialloc.o
	$(CC) $(CFLAGS)  -o zdump $(OBJECTS)  $(LDFLAGS)


ialloc.o:		 $(INC)/sys/types.h time.h \
		 $(INC)/stdio.h $(INC)/tzfile.h 
...
install: ALL
	install -f $(DIR) -u bin -g bin -m 0555 $(MAINS)
